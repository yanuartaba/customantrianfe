...
function ConfirmationDelete(props) {
  // const [valueConfirmation, setValueConfirmation] = useState(false);
  // const navigate = useNavigate();

  // const deleteData = {
  //   //   navigate(0);
  //   //   setValueConfirmation(true);
  // };

  //   const handleDelete = () => {
  //     setValueConfirmation(true);
  //     isDelete(valueConfirmation);
  //   };

  const { showDeleteModal, toggleDelete, model, handleDelete } = props;
  useEffect(() => {
    // console.log(props);
  }, [props]);
        ...
        >
          <div class="relative w-full h-full max-w-md md:h-auto">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <h3 className="px-6 pt-6 mt-12">Confirmation</h3>
